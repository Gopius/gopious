		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-signin py-11">
								...
								<form class="form" method="POST" novalidate="novalidate" id="kt_login_signin_form">
									...
									<div class="form-group">
										...
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="email" autocomplete="off" maxlength="255" />
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
									<div class="form-group">
							...
							<div class="login-form login-forgot pt-11">
								<!--begin::Form-->
								<form class="form" method="POST" action="{{ route('forgot_password') }}" novalidate="novalidate" id="kt_login_forgot_form">
									@csrf
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<!--end::Title-->
					<!--begin::Image-->
					<div class="content-img d-flex bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(/assets/media/svg/illustrations/login-visual-2.svg);"></div>
					<!--end::Image-->
				</div>
				<!--end::Content-->
			</div>
