													...
													<div class="card-body">
														<div class="col-sm-6 float-left">
															...
															<div class="form-group">
															   ...
															   <input maxlength="255" type="text" class="form-control form-control-solid" name="learner_name" required />
															   <span class="form-text text-muted">Please enter Learner's Fullname</span>
															</div>

															<div class="form-group">
															   <label>Email: <span class="text-danger">*</span></label>
															   <input maxlength="255" type="email" class="form-control form-control-solid" name="learner_email" required />
														...
														<div class="col-sm-6 float-left">
															<div class="form-group">
															   <label>Phone:</label>
															   <input maxlength="255" type="phone" class="form-control form-control-solid" name="learner_phone"  required/>
