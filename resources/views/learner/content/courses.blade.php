												...
												<div class="card-body ">
													...
													<div class="pt-4">
														...
														<div class="progress w-100">
														    <div class="progress-bar bg-success" role="progressbar" style="width: {{ $course->block_count > 0 ? ( ($course->block_count_viewed/$course->block_count ) *100 ):0 }}%; background-color:green !important;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
														</div>
														<!--begin::Action-->
