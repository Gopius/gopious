										...
										<div class="row">
											...
											<div class="col-sm-4">
												...
												<div class="card card-custom gutter-b">
                                                    ...
                                                    <div class="card-header border-0 pt-5">
                                                        <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label font-weight-bolder text-dark">Requirements</span>
                                                        {{-- @dd($requirement) --}}
                                                        <span
                                                        class="text-muted mt-3 font-weight-bold font-size-sm">{{ $requirements->count() }}&nbsp; Requirements
                                                        </span>
                                                        </h3>
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			@foreach ($requirements as $requirement)
																				<tr>
																				<td class="pl-0">
																					<span class="text-muted font-weight-bold d-block"> {{$requirement->requirement_title}}</span>
																				</td>
												...
												<div class="card card-custom gutter-b">
                                                    ...
                                                    <div class="card-header border-0 pt-5">
                                                        <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label font-weight-bolder text-dark">Outcome</span>
                                                        {{-- @dd($requirement) --}}
                                                        <span
                                                        class="text-muted mt-3 font-weight-bold font-size-sm">{{ $outcome->count() }}&nbsp; Outcome
                                                        </span>
                                                        </h3>
															...
															<div class="tab-pane fade active show" id="kt_tab_pane_2_3" role="tabpanel" aria-labelledby="kt_tab_pane_2_3">
																...
																<div class="table-responsive">
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			@foreach ($outcome as $return)
																				<tr>
																				<td class="pl-0">
																					<span class="text-muted font-weight-bold d-block"> {{$return->outcome_title}}</span>
																				</td>
