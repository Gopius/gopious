									...
									<div class="flex-md-row-auto w-md-275px w-xl-325px">
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted mt-3 font-weight-bold font-size-sm">24 Total Courses</span>
												</h3>
												...
												<div>
													...
													<div class="d-flex align-items-center mb-8">
														...
														<div class="d-flex flex-column">
															<!--begin::Title-->
															<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">English</a>
															<!--end::Title-->
															<!--begin::Text-->
													...
													<div class="d-flex align-items-center mb-8">
														...
														<div class="d-flex flex-column">
															<!--begin::Title-->
															<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">Geography</a>
															<!--end::Title-->
															<!--begin::Text-->
															<span class="text-muted font-weight-bold font-size-sm pb-4">Amazing Short Story About
															<br />Darius greatness</span>
													...
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<!--begin::Title-->
															<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">Critical Thinking</a>
															<!--end::Title-->
															<!--begin::Text-->
															<span class="text-muted font-weight-bold font-size-sm pb-4">Amazing Short Story About
															<br />Darius greatness</span>
										...
										<div class="card card-custom gutter-b">
											...
											<div class="card-header align-items-center border-0 mt-4">
												<h3 class="card-title align-items-start flex-column">
													<span class="font-weight-bolder text-dark">Stats</span>
													<span class="text-muted mt-3 font-weight-bold font-size-sm">8,	344 Users</span>
												</h3>
												<div class="card-toolbar">
											...
											<div class="card-body pt-4">
												...
												<div class="timeline timeline-6 mt-3">
													...
													<div class="timeline-item align-items-start">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="font-weight-mormal font-size-lg timeline-content text-muted pl-3">last login</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item align-items-start">
														...
														<div class="timeline-content d-flex">
															<span class="font-weight-bolder text-dark-75 pl-3 font-size-lg">New User Added</span>
														</div>
														<!--end::Content-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item align-items-start">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content font-weight-bolder font-size-lg text-dark-75 pl-3">New class
														<a href="#" class="text-primary">Math</a> added</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item align-items-start">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">site description edited</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item align-items-start">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content font-weight-bolder text-dark-75 pl-3 font-size-lg">New Student
														<a href="#" class="text-primary">Sarah</a> added</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item align-items-start">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">3 Unread Messages</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
												</div>
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex flex-column flex-grow-1">
																<span>
																	...
																	posted in
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder"> JSS 3 </a>
																	class
																</span>
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-body">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex flex-column flex-grow-1">
																<span>
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Goodnews</a>
																	posted in
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder"> history </a>
																	class
																</span>
																<span class="text-muted font-weight-bold">Yestarday at 5:06 PM</span>
													...
													<div class="card-body">
														...
														<div>
															...
															<div class="d-flex align-items-center pb-4">
																...
																<div class="d-flex flex-column flex-grow-1">
																	<span>
																		<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">You</a>
																		posted in
																		<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder"> JSS 3 </a>
																		class
																	</span>
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-body">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex flex-column flex-grow-1">
																<span>
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Blessing</a>
																	posted in
																	<a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder"> Primary 6 </a>
																	class
																</span>
																<span class="text-muted font-weight-bold">Yestarday at 5:06 PM</span>
															</div>
												...
												<div class="card card-custom gutter-b">
													...
													<div class="card-header border-0 pt-5">
														<h3 class="card-title align-items-start flex-column">
															...
															<span class="text-muted mt-3 font-weight-bold font-size-sm">Math is starting in
															<span class="text-primary">9 minutes</span></span>
														</h3>
														<div class="card-toolbar">
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Music</a>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Trigonometry</a>
																			...
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Maths Quiz</a>
																					<span class="text-muted font-weight-bold d-block">in Primary 5</span>
																				</td>
																				<td></td>
																				<td class="text-left">
