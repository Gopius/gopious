														...
														<div class="col-sm-8 float-left">
                                                            ...
                                                            <form method="post"  enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    value="{{Auth::guard('learner')->user()->learner_name}}" maxlength="255" required />
															...
															<div class="row">
                                                                <div class="form-group col-sm-6">
                                                                    <form method="post"  enctype="multipart/form-data">
                                                                        ...
                                                                        value="{{Auth::guard('learner')->user()->learner_phone}}" maxlength="255" required />
																...
																<div class="form-group col-sm-6">
                                                                    <form method="post"  enctype="multipart/form-data">
                                                                        @csrf
                                                                        <label>Email:</label>
                                                                        <input name="learner_email" type="text" class="form-control form-control-solid" value="{{Auth::guard('learner')->user()->learner_email}}" maxlength="255" required />
