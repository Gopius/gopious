								...
								<div class="d-flex flex-column flex-md-row">
									...
									<div class="flex-md-row-auto w-md-275px w-xl-325px">
														...
														<div class="d-flex flex-column flex-center">
															...
															<div class="d-flex align-items-center">
																<div class="image-input image-input-outline symbol " id="kt_user_avatar" style="background-image: url(assets/media/stock-600x400/img-70.jpg); width: 300px;height: 160px;">
																	<div class="image-input-wrapper symbol " style=" width: 300px;height: 160px;background-position: center; background-image: url({{ asset('storage/'.$class->cat_cover_image) }});"></div>
													...
													@foreach ($courses as $course)
														...
														<div class="d-flex align-items-center mb-8">
															...
															<div class="d-flex flex-column">
																<!--begin::Title-->
																<a href="{{ route('learner_class_course', [$class->cat_id, $course->course_id]) }}" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$course->course_title}}</a>
																<!--end::Title-->
																<!--begin::Text-->
																...
																<!--begin::Action-->
																<div>
																	<a href="{{ route('learner_class_course', [$class->cat_id, $course->course_id]) }}"><button type="button" class="btn btn-light font-weight-bolder font-size-sm py-2">Enter Course</button></a>
																</div>
																<!--end::Action-->
															</div>
															<!--end::Info-->
										...
										{{-- <div class="card card-custom gutter-b">
											...
											<div class="card-header border-0 pt-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Polls</span>
																	...
																	@foreach ($polls as $poll)
																		<tr>
																			...
																			<td class="text-right pr-0">
																				...
																				<a href="{{ route('learner_class_poll', [$class->cat_id, $poll->poll_id]) }}" class="btn btn-icon btn-light btn-sm">
											...
											<div class="col-xxl-8">
												...
												<div class="card card-custom gutter-b">
													...
													<form id="kt_forms_widget_2_form" class=" ql-quil ql-quil-plain" onsubmit="return sendTimeLinePost(this);" method="post" enctype="multipart/form-data">
														@csrf
														<input type="hidden" name="_plink" value="{{route('learner_class_upload_post', [$class->cat_id])}}">
														<input type="hidden" name="_clink" value="{{route('learner_class_upload_post_comment', [$class->cat_id])}}">
														<input type="hidden" name="_llink" value="{{route('learner_class_upload_post_like', [$class->cat_id])}}">
														<div class="card-body">
															<!--begin::Top-->
															<div class="d-flex align-items-center">
																<!--begin::Symbol-->
																<div class="symbol symbol-40 symbol-light-success mr-5">
																	<div class="image-input image-input-outline symbol symbol-circle" >
																		<div class="image-input-wrapper symbol " style="background-image: url({{ asset('storage/'.Auth::guard('learner')->user()->learner_avatar_url) }}), url('/assets/media/users/blank.png'); width: 50px; height: 50px;"></div>
																	</div>
																</div>
																<!--end::Symbol-->
																<!--begin::Description-->
															...
															<div class="card-body">
																...
																<div class="pt-5">
																	...
																	<div class="row mx-4 p-4 my-5 bg-light-info rounded">
																		...
																		<div class="col-7">
																			<a href="{{ route('learner_class_poll', [$class->cat_id, $poll->poll_id]) }}" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$poll->poll_title}}</a>
																			<span class="text-muted font-weight-bold d-block">by {{$poll->instructor->instr_name}}</span>
																		</div>
																		<div class="col-2">
																			@if (!$poll->end_date->isPast())
																	...
																	<div class="row mx-4 p-4 my-5 bg-light-info rounded">
																		...
																		<div class="col-4">
																			<a href="{{ route('learner_class_assignment', [$class->cat_id, $assignment->ass_id]) }}" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$assignment->ass_title}}</a>
																		...
																		<div class="col-2">
																			...
																			<a href="{{ route('learner_class_assignment', [$class->cat_id, $assignment->ass_id]) }}" class="btn btn-icon btn-light btn-sm">
																				<span class="svg-icon svg-icon-md svg-icon-success">
																					<i class="fas fa-angle-double-right"></i>
																				</span>
																			</a>
																	...
																	<div class="row mx-4 p-4 my-5 bg-light-info rounded">
																		...
																		<div class="col-4">
																			<a href="{{ route('learner_class_quiz', [$class->cat_id, $quiz->quiz_id]) }}" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$quiz->quiz_title}}</a>
																		...
																		<div class="col-2">
																			<a href="{{ route('learner_class_quiz', [$class->cat_id, $quiz->quiz_id]) }}" class="btn btn-icon btn-light btn-sm">
																				<span class="svg-icon svg-icon-md svg-icon-success">
																					<i class="fas fa-angle-double-right"></i>
																				</span>
																			</a>
																		...
																		<tbody>
																			@foreach ($assignments as $assignment)
																				<tr>
																					...
																					<td class="pl-0">
																						<a href="{{ route('learner_class_assignment', [$class->cat_id, $assignment->ass_id]) }}" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{$assignment->course_title}} </a>
																						<span class="text-muted font-weight-bold d-block">by {{$assignment->instr_name}}</span> in {{$assignment->course_title}}
																					</td>
																					<td></td>
																					<td class="text-left">
																						<span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$assignment->end_date->diffForHumans()}}</span>
