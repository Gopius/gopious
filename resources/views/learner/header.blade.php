...
<html lang="en">
	...
	<head><base href="../">
		...
		<!--end::Layout Themes-->
		@if (Auth::guard('learner')->user()->organization->org_square_icon_url !== null)
			<link rel="shortcut icon" href="{{ asset('storage/'.Auth::guard('learner')->user()->organization->org_square_icon_url) }}" />
		@else
...
@endphp
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image: url({{ asset('storage/'.Auth::guard('learner')->user()->learner_avatar_url) }})"></div>
						<i class="symbol-badge bg-success"></i>
					</div>
					<div class="d-flex flex-column">
						<a href="{{ route('learner_profile') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{Auth::guard('learner')->user()->learner_name}} </a>
						...
						<div class="navi mt-2">
							...
							<a href="{{ route('learner_logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Logout</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			<!--begin::Logo-->
			<a href="{{ route('learner_dashboard') }}" class="mr-20">
				@if ( Auth::guard('learner')->user()->organization->org_long_icon_url !== null)
					<img alt="Logo" src="{{ asset('storage/'.Auth::guard('learner')->user()->organization->org_long_icon_url) }}" class="max-h-35px" />
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="{{ route('learner_dashboard') }}" class="nav-link py-4 px-6 {{$header=='home'?'active':''}}" >Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="{{ route('learner_classes') }}" class="nav-link py-4 px-6  {{$header=='class'?'active':''}}" role="tab">Classes</a>
										</li>
										<!--end::Item-->
													...
													<div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
														...
														<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a class="text-dark text-hover-primary mb-1 font-size-lg">New Assignment Alert</a>
															...
															<div class="d-flex align-items-center mb-6">
																...
																<div class="d-flex flex-column font-weight-bold">
																	<a class="text-dark text-hover-primary mb-1 font-size-lg">New Quiz Alert</a>
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-sm-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-sm-inline">{{Auth::guard('learner')->user()->learner_name}}</span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-sm-inline">{{Auth::guard('learner')->user()->organization->org_name}}</span>
											</div>
											<span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">{{strtoupper(substr(Auth::guard('learner')->user()->organization->org_name, 0,1))}}</span>
											</span>
										</div>
									</div>
									<!--end::User-->
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
										...
										<li class="nav-item mr-2">
											<a href="{{ route('learner_dashboard') }}" class="nav-link btn btn-clean {{$header=='home'?'active':''}}"  role="tab">Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="{{ route('learner_classes') }}" class="nav-link btn btn-clean  {{$header=='class'?'active':''}}"  role="tab">Classes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="{{ route('learner_courses') }}" class="nav-link btn btn-clean {{$header=='course'?'active':''}}" role="tab">Activities</a>
										</li>
										<!--end::Item-->
