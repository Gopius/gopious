<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Reset Password Instructor | Go pius</title>
		...
		<!--end::Layout Themes-->
		@if ($setting->organization->org_square_icon_url !== null && $setting->organization->org_square_icon_url !== '')
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
							...
							<div class="login-form login-signin py-11">
								...
								<form class="form" method="POST" novalidate="novalidate" id="kt_login_signin_form">
									...
									<div class="text-center pt-2">
										<button id="kt_login_signin_submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">Reset Password</button>
									</div>
									<!--end::Action-->
								</form>
								<!--end::Form-->
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<!--end::Title-->
					<!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url({{ asset('assets/media/svg/illustrations/login-visual-5.svg') }});"></div>
					<!--end::Image-->
				</div>
				<!--end::Content-->
			</div>
