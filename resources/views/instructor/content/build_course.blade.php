                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="col-12">
                                    <a
                                        class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{ $course->course_title }}</a>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="new_chapter" class="form-control"
                            ...
                            <div class="mt-2">
                                <a onclick="return pushLastChange(this);" href="{{ route('instructor_activities') }}"
                                    class="btn btn-sm btn-success w-100 mt-5 font-weight-bold py-2 px-3  my-1">Done</a>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="form-group w-100 d-block">
                                    ...
                                    @endphp
                                    <div class="  col-sm-12">
                                        <select class="form-control select2" id="select_quiz" name="param"
                                            multiple="multiple">
...
<script>
  ...
  $('.summernote').summernote({
    ...
    minHeight: 290,             // set minimum height of editor
    maxHeight: 290,
