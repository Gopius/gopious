                                ...
                                <div class="pb-5">
                                    ...
                                    <div class="d-flex flex-column flex-center">
                                        ...
                                        <div class="image-input image-input-outline symbol symbol-circle">
                                            <div class="image-input-wrapper symbol symbol-circle "
                                                style="background-image: url({{ asset('storage/' . $user->learner_avatar_url) }}), url('/assets/media/users/blank.png')">
                                            </div>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Username-->
                                        <a
                                            class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">{{ $user->learner_name }}</a>
                                        <!--end::Username-->
                                        <!--begin::Info-->
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span
                                    class="text-muted mt-3 font-weight-bold font-size-sm">{{ $user->classes->count() }}
                                    Classes</span>
                            </h3>
                                ...
                                @foreach ($user->classes as $class)
                                    ...
                                    <div class="d-flex align-items-center mb-8">
                                        ...
                                        <div class="d-flex flex-column">
                                            <!--begin::Title-->
                                            <a
                                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $class->cat_title }}</a>
                                            <!--end::Title-->
                                            <!--begin::Text-->
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingOne6">
                                        <div class="card-title" data-toggle="collapse" data-target="#collapseOne6">
                                            <i class="flaticon-pie-chart-1"></i> Courses
                                        </div>
                                    </div>
                                                                ...
                                                                <td class="m-0 p-0">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            {{ strtoupper(substr(explode(' ', $assignment->course_title)[0] ?? '', 0, 1)) }}{{ strtoupper(substr(explode(' ', $assignment->course_title)[1] ?? '', 0, 1)) }}
                                                                        </span>
                                                                    </div>
                                                                </td>
                                                                <td class="pl-0">
                                                                    <a href="{{ route('instructor_assignment_submissions', [$assignment->cat_no, $assignment->ass_id]) }}"
                                                                        class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $assignment->course_title }}
                                                                    </a>
                                                                    ...
                                                                    <span class="text-muted font-weight-bold d-block">
                                                                        {{ $assignment->course_desc }}</span>
                                                                </td>
                                                                <td>
                                                                    <div class="text-{{$assignment->course_status==0?'warning':($assignment->course_status==1 ? 'success':'danger') }}">
                                                                        {{$assignment->course_status==0?'Closed':($assignment->course_status==1 ? 'Active':'Closed') }}
