                            ...
                            <div class="h-100">
                                ...
                                <div class="d-flex flex-column flex-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="image-input image-input-outline symbol " id="kt_user_avatar"
                                            style="background-image: url(assets/media/stock-600x400/img-70.jpg); width: 300px;height: 160px;">
                                            <div class="image-input-wrapper symbol "
                                                style=" width: 300px;height: 160px;background-position: center; background-image: url({{ asset('storage/' . $class->cat_cover_image) }});">
                                            </div>
                                    ...
                                    <!--end::Title-->
                                    <span
                                        class="font-weight-bolder label label-xl label-secondary label-inline px-3 py-5 min-w-45px mb-2">Class
                                        Code: {{ $class->cat_code }}</span>
                                    <!--begin::Text-->
                                ...
                                <div class="pt-1">
                                    ...
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <!--begin::label-->
                                        <span
                                            class="font-weight-bolder label label-xl label-light-success label-inline px-3 py-5 min-w-45px">{{ count($learners) }}</span>
                                        <!--end::label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a
                                                class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Instructors</a>

                                        </div>
                                        <!--end::Text-->
                                        <!--begin::label-->
                                        <span
                                            class="font-weight-bolder label label-xl label-light-danger label-inline px-3 py-5 min-w-45px">{{ count($instructors) }}</span>
                                        <!--end::label-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="d-flex align-items-center pb-9">
                                        ...
                                        <div class="d-flex flex-column flex-grow-1">
                                            <a
                                                class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">Courses</a>

                                        </div>
                                        <!--end::Text-->
                                        <!--begin::label-->
                                        <span
                                            class="font-weight-bolder label label-xl label-light-primary label-inline py-5 min-w-45px">{{ count($courses) }}</span>
                                        <!--end::label-->
                                    </div>
                                    <!--end::Item-->
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-3 font-weight-bold font-size-sm">{{ count($courses) }} Total
                                Courses</span>
                        </h3>
                    ...
                    <div class="card-body pt-4">
                                ...
                                <div class="d-flex align-items-center mb-8">
                                    ...
                                    <div class="symbol mr-5 pt-1">
                                        <div class="symbol-label min-w-65px min-h-100px"
                                            style="background-image: url({{ asset('storage/' . $course->course_cover_img_url) }})">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        <!--begin::Title-->
                                        <a
                                            class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{ $course->course_title }}</a>
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <span
                                            class="text-muted font-weight-bold font-size-sm pb-4">{{ $course->course_desc }}</span>
                                        <!--end::Text-->
                                        <!--begin::Action-->
                        ...
                        <!--end::Container-->
                        <div class="d-flex flex-center mr-5" id="kt_sticky_toolbar_chat_toggler_2" data-toggle="tooltip"
                        ...
                        <div class="tab-content mt-5" id="myTabTables10">
                            ...
                            <div class="tab-pane fade show active" id="kt_tab_pane_10_2" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                                ...
                                                <tr>
                                                    <td class="m-0 p-0">
                                                        <div class="symbol symbol-45 symbol-light-danger mr-2">
                                                            <span
                                                                class="symbol-label font-size-h5 font-weight-bolder text-danger ">
                                                                {{ strtoupper(substr(explode(' ', $poll->poll_title)[0] ?? '', 0, 1)) }}{{ strtoupper(substr(explode(' ', $poll->poll_title)[1] ?? '', 0, 1)) }}
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td class="pl-0">
                                                        <a href="{{ route('instructor_poll_view', [$class->cat_id, $poll->poll_id]) }}"
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $poll->poll_title }}</a>
                                    ...
                                    <div class="d-flex flex-center mr-5" id="kt_sticky_toolbar_chat_toggler_2"
            ...
            <div class="flex-md-row-fluid ml-md-6 ml-lg-8">
                <div class="row">
                    <div class="col-xxl-8">
                        ...
                        <div class="card card-custom gutter-b">
                            <!--begin::Body-->
                            <form id="kt_forms_widget_2_form" class=" ql-quil ql-quil-plain"
                                onsubmit="return sendTimeLinePost(this);" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="_plink"
                                    value="{{ route('instructor_class_upload_post', [$class->cat_id]) }}">
                                <input type="hidden" name="_clink"
                                    value="{{ route('instructor_class_upload_post_comment', [$class->cat_id]) }}">
                                <input type="hidden" name="_llink"
                                    value="{{ route('instructor_class_upload_post_like', [$class->cat_id]) }}">
                                <div class="card-body">
                                    <!--begin::Top-->
                                    <div class="d-flex align-items-center">
                                        <!--begin::Symbol-->
                                        <div class="image-input image-input-outline symbol symbol-circle">
                                            <div class="image-input-wrapper symbol "
                                                style="background-image: url({{ asset('storage/' . Auth::guard('instructor')->user()->instr_avatar_url) }}), url('/assets/media/users/blank.png'); width: 50px; height: 50px;">
                                            </div>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Description-->
                                        <span class="text-muted font-weight-bold font-size-lg">&nbsp; Please share your
                                            thoughts, {{ Auth::guard('instructor')->user()->instr_name }}?</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Top-->
                                    <!--begin::Form-->
                        ...
                        @if (count($posts) == 0)
                            <span
                                class="d-block w-100 mt-20 p-4 bg-light-primary text-primary font-weight-bold text-center">
                                No Post</span>
                        @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="image-input image-input-outline "
                                                style="background-image: url('/assets/media/users/blank.png'); width: 40px; height: 40px;">
                                                @php
                                                    $user_img_path = $post->post_instructor->instructor->instr_avatar_url ?? ($post->post_learner->learner->learner_avatar_url ?? '');
                                                @endphp
                                                <div class="image-input-wrapper"
                                                    style="background-image: url({{ asset('storage/' . $user_img_path) }}); width: 40px; height: 40px;">
                                                </div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Info-->
                                            <div class="d-flex flex-column flex-grow-1">
                                                <span>
                                                    <a
                                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{ $post->post_instructor->instructor->instr_name ?? ($post->post_learner->learner->learner_name ?? '') }}</a>
                                                    posted in
                                                    <a
                                                        class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">
                                                        {{ $post->class->cat_title }} </a>
                                                    class
                                                </span>
                                                <span
                                                    class="text-muted font-weight-bold">{{ $post->created_at->diffForHumans() }}</span>
                                            </div>
                                            <!--end::Info-->
                                        ...
                                        <div class="pt-5">
                                            @foreach ($post->attachments as $attachment)
                                                <div class=" mt-2 bgi-no-repeat bgi-size-cover rounded min-h-265px"
                                                    style="background-image: url({{ asset('storage/' . $attachment->url) }})">
                                                </div>
                                            @endforeach
                                            <!--begin::Text-->
                                            <p class="text-dark-75 font-size-lg font-weight-normal mb-2">
                                                <?= $post->content ?></p>
                                            @if ($post->type == 1 && $post->coursePost !== null && $post->coursePost->course !== null)
                                            ...
                                            @endif
                                            @if ($post->type == 2 && $post->pollPost !== null && $post->pollPost->poll !== null)
                                                <div class="row mx-4 p-4 my-5 bg-light-info rounded">
                                                    @php
                                            ...
                                            @endif
                                            @if ($post->type == 3 && $post->assignmentPost !== null && $post->assignmentPost->assignment !== null)
                                                <div class="row mx-4 p-4 my-5 bg-light-info rounded">
                                                    @php
                                                    ...
                                                    <div class="col-4">
                                                        <a
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $assignment->ass_title }}</a>
                                                        <span class="text-muted font-weight-bold d-block">by
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <span
                                                            class="text-muted font-weight-bold d-block font-size-sm">Deadline</span>
                                                    </div>
                                                    <div class="col-2">
                                                        @if ($assignment->instr_no == Auth::guard('instructor')->user()->instr_id)
                                                            <a href="{{ route('instructor_assignment_submissions', [$class->cat_id, $assignment->ass_id]) }}"
                                                                class="btn btn-icon btn-light btn-sm">
                                                                <span class="svg-icon svg-icon-md svg-icon-success">
                                                                    <i class="fas fa-angle-double-right"></i>
                                                                </span>
                                            ...
                                            @endif
                                            @if ($post->type == 4 && $post->quizPost !== null && $post->quizPost->quiz !== null)
                                                <div class="row mx-4 p-4 my-5 bg-light-info rounded">
                                                    @php
                                                    ...
                                                    <div class="col-4">
                                                        <a
                                                            class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $quiz->quiz_title }}</a>
                                                        <span class="text-muted font-weight-bold d-block">by
                                                            {{ $quiz->instructor->instr_name }}</span>

                                                    </div>
                                                    <div class="col-3">
                                                        <span
                                                            class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $quiz->start_date->diffForHumans() }}</span>
                                                        <span
                                                            class="text-muted font-weight-bold d-block font-size-sm">Starts</span>
                                                    </div>
                                                    <div class="col-2">
                                                        @if ($quiz->instr_no == Auth::guard('instructor')->user()->instr_id)
                                                            <a href="{{ route('instructor_quiz_submissions', [$class->cat_id, $quiz->quiz_id]) }}"
                                                                class="btn btn-icon btn-light btn-sm">
                                                                <span class="svg-icon svg-icon-md svg-icon-success">
                                                                    <i class="fas fa-angle-double-right"></i>
                                                                </span>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a onclick="displayComment(this)"
                                                    ...
                                                    <span
                                                        class="comment_post_count">{{ $post->comments->count() }}</span></a>
                                                <a onclick="likePost(this)"
                                                    class="btn btn-sm btn-text-dark-50 btn-hover-icon-danger btn-hover-text-danger
                                                    ...
                                                    <div class="d-flex py-5">
                                                        ...
                                                        <div class="d-flex flex-column flex-row-fluid">
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap">
                                                                <a
                                                                    class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder pr-6">{{ $comment->instructor->instr_name ?? ($comment->learner->learner_name ?? '') }}</a>
                                                                <span
                                                                    class="text-muted font-weight-normal flex-grow-1 font-size-sm">{{ $comment->created_at->diffForHumans() }}</span>

                                                            </div>
                                                            <span
                                                                class="text-dark-75 font-size-sm font-weight-normal pt-1">{{ $comment->content }}
                                                                <a href="{{ route('comment_delete',$comment->id) }}" class="delete float-right"><i
                                                                        class="fas fa-trash"
                                                                        style="color: red; margin-left:15px"></i></a>&nbsp;
                                                                <a href="" class="edit float-right" data-toggle="modal"
                                                                    data-target="#exampleModal{{ $comment->id }}"><i
                                                                        class="fas fa-pen "
                                                                        style="color: #1bc5bd;"></i></a>
                                                            </span>
                                                            ...
                                                            <div class="modal fade" id="exampleModal{{ $comment->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
																		...
																		<form action="{{ route('comment_edit') }}" method="POST">
                                        ...
                                        <form class="position-relative" method="post"
                                            onsubmit="return sendPostComment(this)">
                                            ...
                                            <textarea id="kt_forms_widget_3_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1"
                                                placeholder="Reply..." maxlength="255" name="content"
                                                required></textarea>
                                            <div class="position-absolute top-0 right-0 mt-n1 mr-n2">

                                                <button type="submit"
                                                    class="btn btn-icon btn-md btn-hover-icon-primary">
                    ...
                    <div class="col-xxl-4">
                        ...
                        <div class="card card-custom gutter-b pt-10">
                            <div class="col-sm-12 px-2 m-0 month-changer">
                                <i class="fa fas fa-chevron-circle-left float-left main-text-color  icon-xl text-primary"
                                    onclick="(()=>{document.querySelector('#previous-month').click()})()"> </i>
                                <i class="fa fas fa-chevron-circle-right float-right main-text-color  icon-xl text-primary"
                                    onclick="(()=>{document.querySelector('#next-month').click()})()"> </i>
                            </div>
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">Total Assignment
                                        <span class="text-primary">{{ $assignments->count() }}</span></span>
                                </h3>
                                ...
                                <div class="tab-content mt-5" id="myTabTables10">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_tab_pane_10_2" role="tabpanel"
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="d-flex flex-center mb-12" id="kt_sticky_toolbar_chat_toggler_1"
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    @isset($quizzes[0])
                                        <span
                                            class="text-muted mt-3 font-weight-bold font-size-sm">{{ $quizzes[0]->quiz_title }}
                                            is starting
                                            <span class="text-primary">{{ $quizzes[0]->start_date->diffForHumans() }}
                                                minutes</span></span>
                                    @endisset
                                </h3>
                            ...
                            <div class="card-body pt-2 pb-0 mt-n3">
                                <div class="tab-content mt-5" id="myTabTables10">
                                    <!--begin::Tap pane-->
                                    <div class="tab-pane fade  show active" id="kt_tab_pane_10_1" role="tabpanel"
