															...
															<tr>
																...
																<td class="pl-0">
																	...
																	<div class="progress w-100">
																	    <div class="progress-bar bg-success" role="progressbar" style="width: {{ $learner->block_count > 0 ? ( ($learner->block_count_viewed/$learner->block_count ) *100 ):0 }}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
