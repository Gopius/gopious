	...
	<head><base href="../">
		...
		@switch($view)
		    ...
		    @case('add_course_without_class')
		        ...
		        <link href="{{ asset('/assets/css/CalendarPicker.style.css') }}" rel="stylesheet" type="text/css" />
		        @break
		...
		<!--end::Layout Themes-->
		@if (Auth::guard('instructor')->user()->organization->org_square_icon_url !== null && Auth::guard('instructor')->user()->organization->org_square_icon_url !== '')
    ...
    @endphp
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image: url({{ asset('storage/'.Auth::guard('instructor')->user()->instr_avatar_url) }})"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							<a href="{{ route('instructor_profile') }}" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{Auth::guard('instructor')->user()->instr_email}}</span>
								</span>
							</a>
							<a href="{{ route('instructor_logout') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Logout</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			...
			<a href="{{ route('instructor_dashboard') }}">
				@if ( Auth::guard('instructor')->user()->organization->org_long_icon_url !== null && Auth::guard('instructor')->user()->organization->org_long_icon_url !== '')
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<ul class="header-tabs nav align-self-end font-size-lg" role="tablist">
										<!--begin::Item-->
										<li class="nav-item">
											<a href="{{ route('instructor_dashboard') }}" class="nav-link py-4 px-6 {{$header=='home'?'active':''}}" >Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="{{ route('instructor_classes') }}" class="nav-link py-4 px-6  {{$header=='class'?'active':''}}" role="tab">Classes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="{{ route('instructor_activities') }}" class="nav-link py-4 px-6  {{$header=='course'?'active':''}}" role="tab">Activities</a>
										</li>
										<!--end::Item-->

										<!--begin::Item-->
										<li class="nav-item mr-3">
											<a href="{{ route('instructor_learners') }}" class="nav-link py-4 px-6 {{$header=='learner'?'active':''}}" >Learners</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--begin::Tab Navs-->
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-sm-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-sm-inline">{{Auth::guard('instructor')->user()->instr_name}}</span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-sm-inline">{{Auth::guard('instructor')->user()->organization->org_name}}</span>
											</div>
											<span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">{{strtoupper(substr(Auth::guard('instructor')->user()->organization->org_name, 0,1))}}</span>
											</span>
										</div>
									</div>
									<!--end::User-->
								...
								<div class="header-navs header-navs-left" id="kt_header_navs">
									...
									<ul class="header-tabs p-5 p-lg-0 d-flex d-lg-none nav nav-bold nav-tabs" role="tablist">
										...
										<li class="nav-item mr-2">
											<a href="{{ route('instructor_dashboard') }}" class="nav-link btn btn-clean {{$header=='home'?'active':''}}"  role="tab">Home</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="{{ route('instructor_classes') }}" class="nav-link btn btn-clean {{$header=='class'?'active':''}}"  role="tab">Classes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="{{ route('instructor_activities') }}" class="nav-link btn btn-clean {{$header=='course'?'active':''}}"  role="tab">Activities</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item mr-2">
											<a href="{{ route('instructor_learners') }}" class="nav-link btn btn-clean {{$header=='learner'?'active':''}}"  role="tab">Learners</a>
										</li>
										<!--end::Item-->
									</ul>
