        ...
        <form method="POST" onsubmit="return appendText()">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ass_title" class="form-control"  autocomplete="off">
                </div>
                <div class="form-group">
                    <input type="hidden" id="hidden_editor" name="ass_content" class="form-control form-control-solid"  style="height: 325px">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="created_at" class="form-control"  autocomplete="off">
                </div>
                <div class="form-group">
...
<script>
    ...
    window.addEventListener('load', ()=>{
        ...
        $('#updateWholeForm').on('show.bs.modal', function (event) {
            ...
            modal.querySelector('input[name=ass_title]').value = title

            modal.querySelector('input[name=created_at]').value = start_date
