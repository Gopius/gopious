    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Update Poll</h5>
        ...
        <form method="POST" onsubmit="return appendText()">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="poll_title" class="form-control"  autocomplete="off">
                </div>
                <div class="form-group">
...
<script>
    ...
    window.addEventListener('load', ()=>{
        ...
        $('#updateWholeForm').on('show.bs.modal', function (event) {
            ...
            modal.querySelector('input[name=poll_title]').value = title
