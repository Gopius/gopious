<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Admin Login Page | Go pius</title>
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-forgot pt-11">
								<!--begin::Form-->
								<form method="POST" class="form" action="{{ route('admin.forgot_password') }}"   id="kt_login_forgot_form">
									<!--begin::Title-->
									@csrf
									...
									<!--begin::Form group-->
									<div class="form-group">
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" required type="email" placeholder="Email" name="email" autocomplete="off" />
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
									<div class="form-group d-flex flex-wrap flex-center pb-lg-0 pb-3">
										<button type="sunmit" id="kt_login_forgot_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Submit</button>
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					<!--begin::Title-->
					<div class="d-flex flex-column justify-content-center text-center pt-lg-20 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
						<h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">Admin Login</h3>
						<p class="font-weight-bolder font-size-h2-md font-size-lg text-dark opacity-70">Manage Organization Data</p>
					</div>
					<!--end::Title-->
					<!--begin::Image-->
