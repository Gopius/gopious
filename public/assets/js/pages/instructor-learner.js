            ...
            columns: [{
                ...
                template: function(row) {
                    return '\
                            ...
                            <a  href="'+window.location.href+'/delete/'+row.learner_id +'" onclick="confirmDelete('+row.instr_id+');" class="btn btn-sm btn-clean btn-icon" title="Delete">\
                        ...
                        `
                            ...
                            data-phone="${row.learner_phone}"
                            data-name="${row.learner_name}"
                            data-email="${row.learner_email}"
                            data-route="${row.update_route}"
                            >
...
var getAllOrganizationCourses = async ()=>{
    await fetch('/organization/learners-all')
    .then((resp)=>resp.json())
    .then((result)=>{
        // console.log(result);
        mNetSource = result;
