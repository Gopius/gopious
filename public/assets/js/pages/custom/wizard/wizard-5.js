	...
	var _initWizard = function () {
		...
		_wizardObj.on('change', function (wizard) {
			...
			var validator = _validations[wizard.getStep() - 1]; // get validator for currnt step
						console.log('validator', wizard.getStep());
			if (validator) {
		...
		_wizardObj.on('submit', function (wizard) {
			var about_org = document.querySelector("textarea[name=about_org]");
			if (about_org.value == "") {
				Swal.fire({
					text: "Sorry, About Organisation has to be filled.",
					icon: "error",
					buttonsStyling: false,
					confirmButtonText: "Ok, got it!",
					customClass: {
			...
			if (phone.value == "") {
				Swal.fire({
					text: "Sorry,Phone Number has to be filled.",
					icon: "error",
					buttonsStyling: false,
					confirmButtonText: "Ok, got it!",
					customClass: {
			...
			_formEl,
			{
				...
				fields: {
					about_org: {
						validators: {
							notEmpty: {
								message: 'About Organisation is required'
							}
						}
					},
